...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 *
                 * Fokus backup adalah DATABASE (MySQL di hosting, SQLite di lokal).
                 * File non-kode ikut disertakan supaya proses restore mudah: .env (konfigurasi).
                 * Upload/source code bisa dideploy ulang dari repo, sehingga sengaja tidak
                 * ikut dalam backup agar ukuran zip tetap kecil dan cepat.
                 */
                'include' => [
                    base_path('.env'),
                ],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('BACKUP_FILENAME_PREFIX', 'cendana-'),

            /*
             * The disk names on which the backups will be stored.
             */
            'disks' => [
                env('BACKUP_DEST_DISK', 'backups'),
            ],
    ...
    'notifications' => [
        'notifications' => [
            // Notifikasi email/slack NONAKTIF secara default (mail belum dikonfigurasi).
            // Isi daftar ini untuk mengaktifkannya, mis.:
    ...
    'monitor_backups' => [
        [
            'name' => env('APP_NAME', 'laravel-backup'),
            'disks' => [env('BACKUP_DEST_DISK', 'backups')],
            'health_checks' => [
